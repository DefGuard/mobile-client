...
part of 'register_mobile_auth.dart';

// **************************************************************************
// RiverpodGenerator
// **************************************************************************

String _$screenDataHash() => r'7594254bb5290ce06be87b44f7d7e371181e505f';
...
/// See also [_screenData].
class _ScreenDataFamily extends Family<AsyncValue<DefguardInstance>> {
  /// See also [_screenData].
...
/// See also [_screenData].
class _ScreenDataProvider extends AutoDisposeStreamProvider<DefguardInstance> {
  /// See also [_screenData].
  _ScreenDataProvider(int id)
    : this._internal(
  ...
  Override overrideWith(
    Stream<DefguardInstance> Function(_ScreenDataRef provider) create,
  ) {
  ...
  @override
  AutoDisposeStreamProviderElement<DefguardInstance> createElement() {
...
mixin _ScreenDataRef on AutoDisposeStreamProviderRef<DefguardInstance> {
  /// The parameter `id` of this provider.
  int get id;
}

class _ScreenDataProviderElement
    extends AutoDisposeStreamProviderElement<DefguardInstance>
    with _ScreenDataRef {
  _ScreenDataProviderElement(super.provider);

  @override
  int get id => (origin as _ScreenDataProvider).id;
}
