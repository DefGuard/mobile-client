...
class Locations extends Table with TableInfo<Locations, LocationsData> {
  ...
  late final GeneratedColumn<String> mfaSteps = GeneratedColumn<String>(
    'mfa_steps',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> mfaStepPlan = GeneratedColumn<String>(
    'mfa_step_plan',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  LocationsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LocationsData(
      ...
      mfaSteps: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}mfa_steps'],
      )!,
      mfaStepPlan: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class LocationsData extends DataClass implements Insertable<LocationsData> {
  ...
  final String mfaSteps;
  final String mfaStepPlan;
  const LocationsData({
    required this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['mfa_steps'] = Variable<String>(mfaSteps);
    map['mfa_step_plan'] = Variable<String>(mfaStepPlan);
    return map;
  }
  ...
  factory LocationsData.fromJson(
    ...
    return LocationsData(
      ...
      mfaSteps: serializer.fromJson<String>(json['mfaSteps']),
      mfaStepPlan: serializer.fromJson<String>(json['mfaStepPlan']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'mfaSteps': serializer.toJson<String>(mfaSteps),
      'mfaStepPlan': serializer.toJson<String>(mfaStepPlan),
    };
  }
...
class LocationsCompanion extends UpdateCompanion<LocationsData> {
  ...
  final Value<String> mfaSteps;
  final Value<String> mfaStepPlan;
  ...
  LocationsCompanion copyWith({
    ...
    Value<String>? mfaSteps,
    Value<String>? mfaStepPlan,
  }) {
    return LocationsCompanion(
      id: id ?? this.id,
      instance: instance ?? this.instance,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (mfaSteps.present) {
      map['mfa_steps'] = Variable<String>(mfaSteps.value);
    }
    if (mfaStepPlan.present) {
      map['mfa_step_plan'] = Variable<String>(mfaStepPlan.value);
    }
    return map;
  }
